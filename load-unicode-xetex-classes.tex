...
%
% Note that this file is provided as it matches behaviour present in the build
% process for (plain) XeTeX formats since the engine was first developed. The
% granularity of this set up may not be sufficient depending upon the use case.
%
% =============================================================================
%
...
% Write some basic information to the log.
  ...
  \newlinechar=`\^^J %
  \message{^^J}%
  \message{load-unicode-xetex-classes.tex v0.4 (2015-12-07)^^J}%
