...
\begingroup
  ...
  \def\parseunicodedataV#1;#2;#3\relax{%
    \read0 to \unicodedataline
    \expandafter\parseunicodedataVI\unicodedataline\relax#1;#2\relax
  }%
  \def\parseunicodedataVI#1;#2\relax#3;#4\relax{%
