...
%
% Copyright 2015-2017 The LaTeX3 Project
%
...
% Write some basic information to the log.
  ...
  \newlinechar=`\^^J %
  \message{^^J}%
  \message{load-unicode-data.tex v1.6 (2017-06-27)^^J}%
...
% updated when a new download takes place!
  \message{\string# UnicodeData-10.0.0.txt^^J}%
  \message{\string# Downloaded 2017-06-27 17:00:00 GMT [JAW]^^J}%
